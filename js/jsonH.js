JH.mod.add(['jsonH.nav', 'listenResizeWin', 'ad', 'lang'], 'jsonH', function (modName, JH, $$) {
	...
	var _pub_static = function (sJson) {
		...
		_main = function () {
			...
			// var parse = JSON5.parse;
			// var stringify = JSON5.stringify;
			// var parse2 = JSON.parse;
			// var stringify2 = JSON.stringify;
			// JSON5.parse = function () {
			// 	console.log('parse');
			// 	return parse.apply(JSON5, arguments);
			// };
			// JSON5.stringify = function () {
			// 	console.log('stringify');
			// 	return stringify.apply(JSON5, arguments);
			// };
			// JSON.parse = function () {
			// 	console.log('parse2');
			// 	return parse2.apply(JSON5, arguments);
			// };
			// JSON.stringify = function () {
			// 	console.log('stringify2');
			// 	return stringify2.apply(JSON5, arguments);
			// };
		...
		_uiEvt = function () {
			...
			$(_pri.node['compressBtn']).on('click', _pri.uiEvtCallback.compressBtn);
